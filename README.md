...
Issue books to members with issue and due dates
...
Books are issued to members with a due date

On return, the system checks for delays

Fine is calculated automatically if the book is overdue

Database updates book availability and member records
